...
const exp = [
  ...
  },
  {
    ...
    time: "(Mar - July, 2024)",
    desp: "<li>Successfully completed and won Insignia for the IBM Quantum Challenge on Qiskit for Quantum Computing.</li><li>Created unique solutions for 7 graded labs on the most-pressing utility scale Quantum Computing problems like Quantum Noice Modelling and Error Mitigation.</li><li>Attended the Qiskit Global Summer School as a continum of the Quantum Challenge, and got the opportunity to meet with IBM's Quantum Engineers and Interns.</li><li> Learnt more about the specific and highly effective Quantum Computation libraries in Qiskit programming language.</li><li> Worked on Qiskit Terra for creation, execution and optimization of foundation quantum circuits and algorithms. Similarly, I tested and debugged highly noise-affected quantum operations through the Qiskit Aer simulator. Currently, I'm working on Qiskit Experiments and specifically Qiskit Nature for molecular systems on a Quantum level; Qiskit Machine Learning featuring QGANs and parameterized Quantum circuits (PQC) to seamlessly integrate TensorFlow lite and PyTorch for Quantum-enhanced data classification, regression, and generative models.</li><li> Looking forward to implemenet Qiskit Libraries and Algorithms to enhance my Cancer Diagnostic Deep Learing Framework of ResNet-ViT Ensemble.</li>",
  },
  {
    ...
    place: "National Incubation Center of Pakistan",
